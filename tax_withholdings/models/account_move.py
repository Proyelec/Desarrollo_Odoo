...
class AccountMoveWithHoldings(models.Model):
    ...
    withholding_iva_generated = fields.Boolean(string="Nro de Retención", default=False, readonly=True)
    ...
    def generate_withholding_iva(self):
        # Validación de la retención de IVA
        ...
        # Actualización del campo para ocultar el botón
        self.withholding_iva_generated = True
        self.env.cr.commit()  # Asegura que el cambio sea inmediato

        # Retorna la acción del reporte para mostrar el PDF
        return self.env.ref('tax_withholdings.report_tax_withholding_iva').report_action(self)
