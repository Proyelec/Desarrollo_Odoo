...
class HRLoanInstallmentLine(models.Model):
    ...
    amount = fields.Monetary('Monto', currency_field='currency_id')
    interest = fields.Monetary('Total Intereses', currency_field='currency_id')
    ins_interest = fields.Monetary('Interés', currency_field='currency_id')
    installment_amt = fields.Monetary('Cuota Capital', currency_field='currency_id')
    total_installment = fields.Monetary('Total Cuota', compute='get_total_installment', currency_field='currency_id')
